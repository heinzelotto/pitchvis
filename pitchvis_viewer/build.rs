fn main() {
    ...
    if target_os == "android" {
        println!("cargo:rustc-link-search=native=/home/other-user/Android/Sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/35/");
