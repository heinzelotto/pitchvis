...
pub fn setup_debug_text(mut commands: Commands) {
    ...
    commands
        ...
        .with_children(|builder| {
            ...
            builder.spawn((
                TextSpan::new("Press digit (1-9) + +/- to tune, / to reset\n"),
...
pub fn update_analysis_parameters_system(
    ...
    let reset_pressed = keycode.pressed(KeyCode::Slash) || keycode.pressed(KeyCode::NumpadDivide);
    ...
    if digit_count == 2 {
        ...
        if d1 && d2 {
            ...
            if reset_pressed {
                ...
                params.peak_config.min_prominence =
                    params.peak_config.min_prominence.clamp(1.0, 30.0);
            }
        } else if d1 && d3 {
            // Main peak height
            if reset_pressed {
        ...
        // VQT parameters (trigger delayed rebuild)
            ...
            if reset_pressed {
                ...
                vqt_params.mark_changed(Instant::now());
            } else if keycode.just_pressed(KeyCode::Equal)
                || keycode.just_pressed(KeyCode::NumpadAdd)
            {
            ...
            } else if keycode.just_pressed(KeyCode::Minus)
                || keycode.just_pressed(KeyCode::NumpadSubtract)
            {
        ...
        if d1 {
            ...
            if reset_pressed {
                params.bassline_peak_config.min_prominence =
                    defaults.bassline_peak_config.min_prominence;
            } else {
            ...
            if reset_pressed {
                ...
                params.vqt_smoothing_duration_base =
            ...
            if reset_pressed {
                params.scene_calmness_smoothing_duration =
                    defaults.scene_calmness_smoothing_duration;
            } else {
            ...
            if reset_pressed {
                params.tuning_inaccuracy_smoothing_duration =
                    defaults.tuning_inaccuracy_smoothing_duration;
            } else {
        ...
        if vqt_params.should_rebuild(now, 2.0) {
            ...
            match pitchvis_analysis::vqt::Vqt::new(&vqt_params.parameters) {
                ...
                Err(e) => {
                    ...
                    error!(
                        "  Current parameters: Q={:.2}, gamma={:.2}, n_fft={}",
                        vqt_params.parameters.quality,
                        vqt_params.parameters.gamma,
                        vqt_params.parameters.n_fft
                    );
